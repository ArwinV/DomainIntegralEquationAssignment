...
theta_i = int(input("What is the angle of incidence? (Enter in degrees) \n"))
input_angle = theta_i*np.pi/180

q_static = (input("Do you want to calculate and plot the E field for the static grid? [Y/N] \n"))
q_dynamic = (input("Do you want to calculate and plot the E field for the dynamic grid? [Y/N]\n"))
...
""" 
if (q_static == "N" or q_static == "n" or q_static == "No" or q_static == "no"):
    print("No E-field will be calculated for the static grid")
elif (q_static == "Y" or q_static == "y" or q_static == "Yes" or q_static == "yes"):
    #STATIC GRID
    ...
    print("Incorrect input, E-field for the static grid will not be calculated")


"""
Calculation and plotting of E-field with a dynamic grid
""" 
if (q_dynamic == "N" or q_dynamic == "n" or q_dynamic == "No" or q_dynamic == "no"):
    print("No E-field will be calculated for the dynamic grid")
elif (q_dynamic == "Y" or q_dynamic == "y" or q_dynamic == "Yes" or q_dynamic == "yes"):
    #DYNAMIC GRID
    ...
    print("Incorrect input, E-field for the dynamic grid will not be calculated")
